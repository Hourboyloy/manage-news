...
const scrapeKhmerNoteData = async () => {
  try {
    const { data } = await axios.get(
      "https://khmernote.com.kh/news/category/news/page/2"
    );
...
const startScrapeDataFromKhmerNoteInternational2 = async () => {
...
module.exports = startScrapeDataFromKhmerNoteInternational2;
