...
const scrapeKhmerNoteData = async () => {
  try {
    const { data } = await axios.get(
      "https://khmernote.com.kh/news/category/technology"
    );
...
const startScrapeDataFromKhmerNoteTechnology = async () => {
...
module.exports = startScrapeDataFromKhmerNoteTechnology;
