...
const scrapeKhmerNoteData = async () => {
  try {
    const { data } = await axios.get(
      "https://khmernote.com.kh/news/category/news/page/3"
    );
...
const startScrapeDataFromKhmerNoteInternational3 = async () => {
...
module.exports = startScrapeDataFromKhmerNoteInternational3;
