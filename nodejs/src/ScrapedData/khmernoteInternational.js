...
const scrapeKhmerNoteData = async () => {
  try {
    const { data } = await axios.get(
      "https://khmernote.com.kh/news/category/news"
    );
...
const startScrapeDataFromKhmerNoteInternational = async () => {
...
module.exports = startScrapeDataFromKhmerNoteInternational;
