...
const scrapeKhmerNoteData = async () => {
  try {
    const { data } = await axios.get(
      "https://khmernote.com.kh/news/category/news/page/4"
    );
...
const startScrapeDataFromKhmerNoteInternational4 = async () => {
...
module.exports = startScrapeDataFromKhmerNoteInternational4;
