...
const scrapeKhmerNoteData = async () => {
  try {
    const { data } = await axios.get(
      "https://khmernote.com.kh/news/category/national/page/3"
    );
...
const startScrapeDataFromKhmerNoteNational3 = async () => {
...
module.exports = startScrapeDataFromKhmerNoteNational3;
