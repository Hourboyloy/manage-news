...
const scrapeKhmerNoteData = async () => {
  try {
    const { data } = await axios.get(
      "https://khmernote.com.kh/news/category/national/page/2"
    );
...
const startScrapeDataFromKhmerNoteNational2 = async () => {
...
module.exports = startScrapeDataFromKhmerNoteNational2;
